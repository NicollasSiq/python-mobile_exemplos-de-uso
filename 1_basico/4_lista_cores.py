...
def main(page: ft.Page):
    ...
    def cor_selecionada(evento):
        """
        Esta função é executada sempre que o uuário escolhe uma cor.
        """
        # Pegando qual cor foi selecionada
        cor_escolhida = evento.control.value
        
        # Dicionário com as cores disponíveis
        # É como uma "lista de correspndência" entre nome e cor real
        cores_disponiveis = {
            "Azul": ft.Colors.BLUE,
    ...
    page.add(
        ft.Text("Swletor de Cores Mágico! ✨", size=24, weight=ft.FontWeight.BOLD),
        seletor_cor,
        caixa_colorida
    )
